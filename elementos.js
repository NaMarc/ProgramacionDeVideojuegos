class Elementos {
    constructor(app, contenedor, juego) {
        ...
        this.contadorTesoro = new ContadorTesoro(this.app, window.innerWidth - 500, 50);
...
class ContadorTesoro {
    constructor(app, x, y) {
        ...
        const tesoro = PIXI.Sprite.from('assets/iconototem.png');
        tesoro.x = window.innerWidth / 2 + 20;
        tesoro.y = 57;
        tesoro.scale.set(0.9);
        this.app.stage.addChild(tesoro);
    ...
    crearTexto(x, y) {
        ...
        //Centrar en el circulo
        //textoPixi.anchor.set(0.5); 
        textoPixi.x = window.innerWidth / 2;
        textoPixi.y = 50;
    ...
    tesorosEncontrados() {
        this.cantidad += 1;
        this.numerosContador.text = this.cantidad.toString();
    }
